...
const PERCENT_FEMALE = (percent) => (Math.min(254, ((percent * 255) / 100)));

const PIKACHU_BASE_STATS = (gender, flip) => ({
  baseHP: 35,
  baseAttack: 55,
  baseSpeed: 90,
  baseSpAttack: 50,
...
const COSPLAY_PIKACHU_BASE_STATS = (flip) =>
  PIKACHU_BASE_STATS(MON_FEMALE, flip);

const CAP_PIKACHU_BASE_STATS = (flip) => PIKACHU_BASE_STATS(MON_MALE, flip);

const PICHU_BASE_STATS = (flip) => ({
  baseHP: 20,
  baseAttack: 40,
  baseDefense: 15,
  baseSpeed: 60,
...
const CASTFORM_BASE_STATS = (type, color) => ({
  baseHP: 70,
  baseAttack: 70,
  baseDefense: 70,
  baseSpeed: 70,
...
const CHERRIM_BASE_STATS = (color) => ({
  baseHP: 70,
  baseAttack: 60,
  baseDefense: 70,
  baseSpeed: 85,
...
const SHELLOS_BASE_STATS = (color) => ({
  baseHP: 76,
  baseAttack: 48,
  baseDefense: 48,
  baseSpeed: 34,
...
const GASTRODON_BASE_STATS = (color) => ({
  baseHP: 111,
  baseAttack: 83,
  baseDefense: 68,
  baseSpeed: 39,
...
const ROTOM_FORM_BASE_STATS = (type, flip) => ({
  baseHP: 50,
  baseAttack: 65,
  baseDefense: 107,
  baseSpeed: 86,
...
const DEERLING_BASE_STATS = (color) => ({
  baseHP: 60,
  baseAttack: 60,
  baseDefense: 50,
  baseSpeed: 75,
...
const VIVILLON_BASE_STATS = (color) => ({
  baseHP: 80,
  baseAttack: 52,
  baseDefense: 50,
  baseSpeed: 89,
...
const ZYGARDE_50_BASE_STATS = (ability) => ({
  baseHP: 108,
  baseAttack: 100,
  baseDefense: 121,
  baseSpeed: 95,
...
const ZYGARDE_10_BASE_STATS = (ability) => ({
  baseHP: 54,
  baseAttack: 100,
  baseDefense: 71,
  baseSpeed: 115,
...
const ORICORIO_BASE_STATS = (type, color) => ({
  baseHP: 75,
  baseAttack: 70,
  baseDefense: 70,
  baseSpeed: 93,
...
const ROCKRUFF_BASE_STATS = (ability1, ability2, hiddenAbility) => ({
  baseHP: 45,
  baseAttack: 65,
  baseDefense: 40,
  baseSpeed: 60,
...
const SILVALLY_BASE_STATS = (type) => ({
  baseHP: 95,
  baseAttack: 95,
  baseDefense: 95,
  baseSpeed: 95,
...
const MINIOR_METEOR_ATTRIBUTES = () => ({
  baseHP: 60,
  baseAttack: 60,
  baseDefense: 100,
  baseSpeed: 60,
...
const MAGEARNA_BASE_STATS = (color) => ({
  baseHP: 80,
  baseAttack: 95,
  baseDefense: 115,
  baseSpeed: 65,
...
const TOXTRICITY_BASE_STATS = (ability2) => ({
  baseHP: 75,
  baseAttack: 98,
  baseDefense: 70,
  baseSpeed: 75,
...
const ALCREMIE_BASE_STATS = (color) => ({
  baseHP: 65,
  baseAttack: 60,
  baseDefense: 75,
  baseSpeed: 64,
...
export const POKEMON_BASE_STATS = [
  ...
  // SPECIES_PIKACHU
  PIKACHU_BASE_STATS(PERCENT_FEMALE(50), FLIP),
  ...
  // SPECIES_CASTFORM
  CASTFORM_BASE_STATS("TYPE_NORMAL", "BODY_COLOR_GRAY"),
  ...
  // SPECIES_BURMY
  BURMY_BASE_STATS("BODY_COLOR_GREEN"),
  ...
  // SPECIES_CHERRIM
  CHERRIM_BASE_STATS("BODY_COLOR_PURPLE"),

  // SPECIES_SHELLOS
  SHELLOS_BASE_STATS("BODY_COLOR_PURPLE"),

  // SPECIES_GASTRODON
  GASTRODON_BASE_STATS("BODY_COLOR_PURPLE"),
  ...
  // SPECIES_DEERLING
  DEERLING_BASE_STATS("BODY_COLOR_PINK"),
  ...
  // SPECIES_VIVILLON
  VIVILLON_BASE_STATS("BODY_COLOR_WHITE"),
  ...
  // SPECIES_ZYGARDE
  ZYGARDE_50_BASE_STATS("ABILITY_AURA_BREAK"),
  ...
  // SPECIES_ORICORIO
  ORICORIO_BASE_STATS("TYPE_FIRE", "BODY_COLOR_RED"),
  ...
  // SPECIES_SILVALLY
  SILVALLY_BASE_STATS("TYPE_NORMAL"),
  ...
  // SPECIES_MAGEARNA
  MAGEARNA_BASE_STATS("BODY_COLOR_GRAY"),
  ...
  // SPECIES_TOXTRICITY
  TOXTRICITY_BASE_STATS("ABILITY_PLUS"),
  ...
  // SPECIES_ALCREMIE
  ALCREMIE_BASE_STATS("BODY_COLOR_WHITE"),
  ...
  COSPLAY_PIKACHU_BASE_STATS(FLIP),
  // SPECIES_PIKACHU_ROCK_STAR
  COSPLAY_PIKACHU_BASE_STATS(FLIP),
  // SPECIES_PIKACHU_BELLE
  COSPLAY_PIKACHU_BASE_STATS(NO_FLIP),
  ...
  CAP_PIKACHU_BASE_STATS(NO_FLIP),
  // SPECIES_PIKACHU_HOENN_CAP
  CAP_PIKACHU_BASE_STATS(FLIP),
  ...
  PICHU_BASE_STATS(NO_FLIP),

  // SPECIES_UNOWN_B
  UNOWN_BASE_STATS(NO_FLIP),
  // SPECIES_UNOWN_C
  UNOWN_BASE_STATS(NO_FLIP),
  // SPECIES_UNOWN_D
  UNOWN_BASE_STATS(NO_FLIP),
  ...
  CASTFORM_BASE_STATS("TYPE_FIRE", "BODY_COLOR_RED"),
  // SPECIES_CASTFORM_RAINY
  CASTFORM_BASE_STATS("TYPE_WATER", "BODY_COLOR_BLUE"),
  // SPECIES_CASTFORM_SNOWY
  CASTFORM_BASE_STATS("TYPE_ICE", "BODY_COLOR_WHITE"),
  ...
  BURMY_BASE_STATS("BODY_COLOR_BROWN"),
  // SPECIES_BURMY_TRASH_CLOAK
  BURMY_BASE_STATS("BODY_COLOR_RED"),
  ...
  CHERRIM_BASE_STATS("BODY_COLOR_PINK"),

  // SPECIES_SHELLOS_EAST_SEA
  SHELLOS_BASE_STATS("BODY_COLOR_BLUE"),

  // SPECIES_GASTRODON_EAST_SEA
  GASTRODON_BASE_STATS("BODY_COLOR_BLUE"),

  // SPECIES_ROTOM_HEAT
  ROTOM_FORM_BASE_STATS("TYPE_FIRE", FLIP),
  // SPECIES_ROTOM_WASH
  ROTOM_FORM_BASE_STATS("TYPE_WATER", NO_FLIP),
  // SPECIES_ROTOM_FROST
  ROTOM_FORM_BASE_STATS("TYPE_ICE", FLIP),
  // SPECIES_ROTOM_FAN
  ROTOM_FORM_BASE_STATS("TYPE_FLYING", FLIP),
  // SPECIES_ROTOM_MOW
  ROTOM_FORM_BASE_STATS("TYPE_GRASS", FLIP),
  ...
  ARCEUS_BASE_STATS("TYPE_FIGHTING"),
  // SPECIES_ARCEUS_FLYING
  ARCEUS_BASE_STATS("TYPE_FLYING"),
  // SPECIES_ARCEUS_POISON
  ARCEUS_BASE_STATS("TYPE_POISON"),
  // SPECIES_ARCEUS_GROUND
  ARCEUS_BASE_STATS("TYPE_GROUND"),
  // SPECIES_ARCEUS_ROCK
  ARCEUS_BASE_STATS("TYPE_ROCK"),
  // SPECIES_ARCEUS_BUG
  ARCEUS_BASE_STATS("TYPE_BUG"),
  // SPECIES_ARCEUS_GHOST
  ARCEUS_BASE_STATS("TYPE_GHOST"),
  // SPECIES_ARCEUS_STEEL
  ARCEUS_BASE_STATS("TYPE_STEEL"),
  // SPECIES_ARCEUS_FIRE
  ARCEUS_BASE_STATS("TYPE_FIRE"),
  // SPECIES_ARCEUS_WATER
  ARCEUS_BASE_STATS("TYPE_WATER"),
  // SPECIES_ARCEUS_GRASS
  ARCEUS_BASE_STATS("TYPE_GRASS"),
  // SPECIES_ARCEUS_ELECTRIC
  ARCEUS_BASE_STATS("TYPE_ELECTRIC"),
  // SPECIES_ARCEUS_PSYCHIC
  ARCEUS_BASE_STATS("TYPE_PSYCHIC"),
  // SPECIES_ARCEUS_ICE
  ARCEUS_BASE_STATS("TYPE_ICE"),
  // SPECIES_ARCEUS_DRAGON
  ARCEUS_BASE_STATS("TYPE_DRAGON"),
  // SPECIES_ARCEUS_DARK
  ARCEUS_BASE_STATS("TYPE_DARK"),
  // SPECIES_ARCEUS_FAIRY
  ARCEUS_BASE_STATS("TYPE_FAIRY"),
  ...
  DEERLING_BASE_STATS("BODY_COLOR_RED"),
  // SPECIES_DEERLING_WINTER
  DEERLING_BASE_STATS("BODY_COLOR_BROWN"),
  ...
  VIVILLON_BASE_STATS("BODY_COLOR_BLUE"),
  // SPECIES_VIVILLON_TUNDRA
  VIVILLON_BASE_STATS("BODY_COLOR_BLUE"),
  // SPECIES_VIVILLON_CONTINENTAL
  VIVILLON_BASE_STATS("BODY_COLOR_YELLOW"),
  // SPECIES_VIVILLON_GARDEN
  VIVILLON_BASE_STATS("BODY_COLOR_GREEN"),
  // SPECIES_VIVILLON_ELEGANT
  VIVILLON_BASE_STATS("BODY_COLOR_PURPLE"),
  // SPECIES_VIVILLON_MEADOW
  VIVILLON_BASE_STATS("BODY_COLOR_PINK"),
  // SPECIES_VIVILLON_MODERN
  VIVILLON_BASE_STATS("BODY_COLOR_RED"),
  // SPECIES_VIVILLON_MARINE
  VIVILLON_BASE_STATS("BODY_COLOR_BLUE"),
  // SPECIES_VIVILLON_ARCHIPELAGO
  VIVILLON_BASE_STATS("BODY_COLOR_BROWN"),
  ...
  VIVILLON_BASE_STATS("BODY_COLOR_GRAY"),
  ...
  // SPECIES_ZYGARDE_10
  ZYGARDE_10_BASE_STATS("ABILITY_AURA_BREAK"),
  // SPECIES_ZYGARDE_10_POWER_CONSTRUCT
  ZYGARDE_50_BASE_STATS("ABILITY_POWER_CONSTRUCT"),
  ...
  ORICORIO_BASE_STATS("TYPE_ELECTRIC", "BODY_COLOR_YELLOW"),
  // SPECIES_ORICORIO_PAU
  ORICORIO_BASE_STATS("TYPE_PSYCHIC", "BODY_COLOR_PINK"),
  // SPECIES_ORICORIO_SENSU
  ORICORIO_BASE_STATS("TYPE_GHOST", "BODY_COLOR_PURPLE"),

  // SPECIES_ROCKRUFF_OWN_TEMPO
  ROCKRUFF_BASE_STATS( "ABILITY_OWN_TEMPO", "ABILITY_NONE", "ABILITY_NONE"),
  ...
  SILVALLY_BASE_STATS("TYPE_FIGHTING"),
  // SPECIES_SILVALLY_FLYING
  SILVALLY_BASE_STATS("TYPE_FLYING"),
  // SPECIES_SILVALLY_POISON
  SILVALLY_BASE_STATS("TYPE_POISON"),
  // SPECIES_SILVALLY_GROUND
  SILVALLY_BASE_STATS("TYPE_GROUND"),
  // SPECIES_SILVALLY_ROCK
  SILVALLY_BASE_STATS("TYPE_ROCK"),
  // SPECIES_SILVALLY_BUG
  SILVALLY_BASE_STATS("TYPE_BUG"),
  // SPECIES_SILVALLY_GHOST
  SILVALLY_BASE_STATS("TYPE_GHOST"),
  // SPECIES_SILVALLY_STEEL
  SILVALLY_BASE_STATS("TYPE_STEEL"),
  // SPECIES_SILVALLY_FIRE
  SILVALLY_BASE_STATS("TYPE_FIRE"),
  // SPECIES_SILVALLY_WATER
  SILVALLY_BASE_STATS("TYPE_WATER"),
  // SPECIES_SILVALLY_GRASS
  SILVALLY_BASE_STATS("TYPE_GRASS"),
  // SPECIES_SILVALLY_ELECTRIC
  SILVALLY_BASE_STATS("TYPE_ELECTRIC"),
  // SPECIES_SILVALLY_PSYCHIC
  SILVALLY_BASE_STATS("TYPE_PSYCHIC"),
  // SPECIES_SILVALLY_ICE
  SILVALLY_BASE_STATS("TYPE_ICE"),
  // SPECIES_SILVALLY_DRAGON
  SILVALLY_BASE_STATS("TYPE_DRAGON"),
  // SPECIES_SILVALLY_DARK
  SILVALLY_BASE_STATS("TYPE_DARK"),
  // SPECIES_SILVALLY_FAIRY
  SILVALLY_BASE_STATS("TYPE_FAIRY"),
  ...
  MINIOR_CORE_BASE_STATS("BODY_COLOR_RED"),
  // SPECIES_MINIOR_CORE_ORANGE
  MINIOR_CORE_BASE_STATS("BODY_COLOR_RED"),
  // SPECIES_MINIOR_CORE_YELLOW
  MINIOR_CORE_BASE_STATS("BODY_COLOR_YELLOW"),
  // SPECIES_MINIOR_CORE_GREEN
  MINIOR_CORE_BASE_STATS("BODY_COLOR_GREEN"),
  // SPECIES_MINIOR_CORE_BLUE
  MINIOR_CORE_BASE_STATS("BODY_COLOR_BLUE"),
  // SPECIES_MINIOR_CORE_INDIGO
  MINIOR_CORE_BASE_STATS("BODY_COLOR_BLUE"),
  // SPECIES_MINIOR_CORE_VIOLET
  MINIOR_CORE_BASE_STATS("BODY_COLOR_PURPLE"),
  ...
  MAGEARNA_BASE_STATS("BODY_COLOR_RED"),
  ...
  TOXTRICITY_BASE_STATS("ABILITY_MINUS"),
  ...
  ALCREMIE_BASE_STATS("BODY_COLOR_PINK"),
  // SPECIES_ALCREMIE_MATCHA_CREAM
  ALCREMIE_BASE_STATS("BODY_COLOR_GREEN"),
  // SPECIES_ALCREMIE_MINT_CREAM
  ALCREMIE_BASE_STATS("BODY_COLOR_BLUE"),
  // SPECIES_ALCREMIE_LEMON_CREAM
  ALCREMIE_BASE_STATS("BODY_COLOR_YELLOW"),
  // SPECIES_ALCREMIE_SALTED_CREAM
  ALCREMIE_BASE_STATS("BODY_COLOR_WHITE"),
  // SPECIES_ALCREMIE_RUBY_SWIRL
  ALCREMIE_BASE_STATS("BODY_COLOR_YELLOW"),
  // SPECIES_ALCREMIE_CARAMEL_SWIRL
  ALCREMIE_BASE_STATS("BODY_COLOR_BROWN"),
